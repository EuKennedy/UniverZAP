export default {
  ...
  SET_FUNNEL_STAGE_UI_FLAG: 'SET_FUNNEL_STAGE_UI_FLAG',
  SET_FUNNEL_STAGES: 'SET_FUNNEL_STAGES',
  ADD_FUNNEL_STAGE: 'ADD_FUNNEL_STAGE',
  EDIT_FUNNEL_STAGE: 'EDIT_FUNNEL_STAGE',
  DELETE_FUNNEL_STAGE: 'DELETE_FUNNEL_STAGE',
  REORDER_FUNNEL_STAGES: 'REORDER_FUNNEL_STAGES',

  // Kanban — Tasks
  SET_KANBAN_TASK_UI_FLAG: 'SET_KANBAN_TASK_UI_FLAG',
  ...
  SET_CONVERSATION_KANBAN_TASKS: 'SET_CONVERSATION_KANBAN_TASKS',
  REMOVE_CONVERSATION_KANBAN_TASK: 'REMOVE_CONVERSATION_KANBAN_TASK',

  // Tasks module (T2 — personal/team task list)
  SET_TASKS: 'SET_TASKS',
  ...
  // Tasks module (T4 — saved views / filter presets)
  SET_TASK_VIEWS: 'SET_TASK_VIEWS',
  ADD_TASK_VIEW: 'ADD_TASK_VIEW',
  UPDATE_TASK_VIEW: 'UPDATE_TASK_VIEW',
  REMOVE_TASK_VIEW: 'REMOVE_TASK_VIEW',
  SET_TASK_VIEWS_UI_FLAG: 'SET_TASK_VIEWS_UI_FLAG',
