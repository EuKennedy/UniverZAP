...
export const TONE_OPTIONS = [
  { key: 'sales', labelKey: 'ATHENAS.TONES.SALES', icon: 'i-lucide-trending-up' },
  { key: 'support', labelKey: 'ATHENAS.TONES.SUPPORT', icon: 'i-lucide-life-buoy' },
  { key: 'friendly', labelKey: 'ATHENAS.TONES.FRIENDLY', icon: 'i-lucide-smile' },
  { key: 'formal', labelKey: 'ATHENAS.TONES.FORMAL', icon: 'i-lucide-briefcase' },
  { key: 'concierge', labelKey: 'ATHENAS.TONES.CONCIERGE', icon: 'i-lucide-crown' },
];
